function start(){
    ...
    document.getElementById("introd").innerHTML = " <img class='img-result' src='Dados/amor.png' alt=''>"
...
function si(){
    ...
    document.getElementById("pregunta").innerHTML  = " <img class='img-result2' src='Dados/foto.jpg' alt=''>";
